...
const AdminProjects = () => {
  ...
  return (
    <div className="p-6 bg-[#1C1D1E] text-white min-h-screen flex flex-col">
      {/* Header Section */}
      ...
      <div className="flex-grow grid grid-cols-4 gap-6 mb-8">
        {/* TODO Column */}
        <div className="bg-[#292B2F] p-4 rounded-lg">
          ...
          <div className="bg-white text-black p-4 rounded-lg shadow-lg">
            ...
            <p className="text-sm mb-2">Creating UI Designs.</p>
            <span className="text-xs bg-blue-200 text-blue-600 px-2 py-1 rounded-lg">UI Design</span>
          </div>
        </div>
        ...
        <div className="bg-[#292B2F] p-4 rounded-lg">
          ...
          <div className="bg-white text-black p-4 rounded-lg shadow-lg">
            ...
            <span className="text-xs bg-orange-200 text-orange-600 px-2 py-1 rounded-lg">UX Writing</span>
          </div>
        </div>
      ...
      <div className="flex justify-end space-x-4 mt-auto mb-6">
